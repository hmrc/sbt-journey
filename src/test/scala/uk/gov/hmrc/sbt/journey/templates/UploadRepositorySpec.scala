...
class UploadRepositorySpec extends AnyFlatSpec with Matchers {
  val basePackage = QualifiedName("uk.gov.hmrc.sbtjourneytest")

  "UploadRepository.render" should "render a template for FileUploadRepository relative to the base package" in {
    UploadRepository.render(basePackage) shouldBe
      """package uk.gov.hmrc.sbtjourneytest.repositories
        |
  ...
  "UploadRepository.renderSpec" should "render a template for FileUploadRepositorySpec relative to the base package" in {
    UploadRepository.renderSpec(basePackage) shouldBe
      """package uk.gov.hmrc.sbtjourneytest.repositories
        |
