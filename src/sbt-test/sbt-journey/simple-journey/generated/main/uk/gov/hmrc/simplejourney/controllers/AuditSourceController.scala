...
trait AuditSourceBaseController extends FrontendBaseController with I18nSupport {
...
class DefaultAuditSourceController @Inject() (
  ...
  view: views.html.AuditSourceView,
  override val controllerComponents: MessagesControllerComponents
)(implicit ec: ExecutionContext) extends AuditSourceBaseController {
