...
trait ServiceDescriptionBaseController extends FrontendBaseController with I18nSupport {
...
class DefaultServiceDescriptionController @Inject() (
  ...
  view: views.html.ServiceDescriptionView,
  override val controllerComponents: MessagesControllerComponents
)(implicit ec: ExecutionContext) extends ServiceDescriptionBaseController {
