...
trait CipAssessmentPageBaseController extends FrontendBaseController with I18nSupport {
...
class DefaultCipAssessmentPageController @Inject() (
  ...
  view: views.html.CipAssessmentPageView,
  override val controllerComponents: MessagesControllerComponents
)(implicit ec: ExecutionContext) extends CipAssessmentPageBaseController {
